...
const NovaIELTS = () => {
  ...
  const start = () => navigate("/ielts-chat");
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#FAFAF8]">
      ...
      <div
        className="absolute bottom-[-5%] left-[-5%] w-[350px] h-[350px] rounded-full bg-gradient-to-br from-orange-300/30 to-amber-200/25 blur-[80px] animate-float"
        style={{ animationDelay: "2s", animationDuration: "8s" }}
      />
      <div
        className="absolute top-[40%] left-[60%] w-[250px] h-[250px] rounded-full bg-gradient-to-br from-violet-200/25 to-rose-200/20 blur-[80px] animate-float"
        ...
        <div className="flex flex-col items-center gap-8 text-center max-w-md">
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: "0.1s", opacity: 0 }}>
            ...
            <p className="mt-3 text-slate-500 text-lg leading-relaxed">
              Simulate a full IELTS Speaking test with an AI examiner. Get band scores and detailed feedback.
            </p>
          </div>

          <div className="animate-fade-in-up text-left bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-border/50 w-full" style={{ animationDelay: "0.2s", opacity: 0 }}>
            <h3 className="text-sm font-semibold text-slate-700 mb-2">Test Structure:</h3>
            <ul className="text-sm text-slate-500 space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="text-rose-500 font-bold text-xs mt-0.5">1</span>
                <span><strong>Part 1</strong> — 12 questions on familiar topics (15-20s each)</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-rose-500 font-bold text-xs mt-0.5">2</span>
                <span><strong>Part 2</strong> — 1 min prep, then speak for 2 minutes</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-rose-500 font-bold text-xs mt-0.5">3</span>
                <span><strong>Part 3</strong> — 6 discussion questions (20-25s each)</span>
              </li>
            </ul>
          </div>
